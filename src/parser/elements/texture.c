...
/*   Updated: 2025/06/18 15:10:43 by jboon         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	init_texture_fields(t_field *tex_fields, t_tex *tex)
{
	...
	tex_fields[1] = init_field("su", &tex->scale_rot.u, FIELD_FLOAT, init_v2f(0, 1000));
	tex_fields[2] = init_field("sv", &tex->scale_rot.v, FIELD_FLOAT, init_v2f(0, 1000));
	tex_fields[3] = init_field("rot", &tex->scale_rot.z, FIELD_FLOAT, init_v2f(-180, 180));
	tex_fields[4] = init_field("alt_col", &tex->col, FIELD_COL, init_v2f(0, 1));
}
